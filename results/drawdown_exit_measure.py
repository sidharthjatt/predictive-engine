...
def main():
    ...
    w("  diagnostics/liquidity_participation.txt records a largest midcap150 fill of")
    w("  34.46% of its symbol's prior-20-session median volume, 12 of 998 fills above")
    w("  10% (n=1,006 fills, re-measured 2026-09-20). That supersedes the 1,614.52%")
    w("  this line used to quote: the AIIL 2021-06-07 order is in no current")
    w("  daily_trades, because AIIL's price file now starts 2024-04-23. NOTHING HERE")
    w("  CAN SAY WHAT REPEATED FULL LIQUIDATIONS IN MARCH 2020 WOULD HAVE FILLED AT.")
